...
function firstscript() {
	...
	// デフォルトの画像データを配列に格納   
	if(isSupportWebp){
	document.images.image.src = "Data_atago/Data_atago_Webp/data0/image023.webp";
	filename = "Data_atago/Data_atago_Webp/data";
	image_type = ".webp"
	image_load(img_op, filename);
	}
	else{
	document.images.image.src = "Data_atago/Data_atago_jpg/data0/image023.jpg";
	filename = "Data_atago/Data_atago_jpg/data";
	image_type = ".jpg"
	image_load(img_op, filename);
	}
}
...
function kakudai_Click(kakudai, ischecked){
	...
	if(ischecked == true){
		// 拡大画像表示       (框被选中)
		if(isSupportWebp)	filename = "Data_atago/Data_atago_k-6_Webp/data";
		else	filename = "Data_atago/Data_atago_k-6_jpg/data";
...
function kakudai_bar(value){
	if(value == 0){
		...
		if(isSupportWebp)	filename = "Data_atago/Data_atago_k-5_Webp/data";
		else	filename = "Data_atago/Data_atago_k-5_jpg/data";
		image_loadk_5(img_k_5, filename);
		image.src = img_k_5[count_y][count_x].src;
		image_ar = img_k_5;
	}
	else if(value == 2){
		if(isSupportWebp)	filename = "Data_atago/Data_atago_k-4_Webp/data";
		else	filename = "Data_atago/Data_atago_k-4_jpg/data";
